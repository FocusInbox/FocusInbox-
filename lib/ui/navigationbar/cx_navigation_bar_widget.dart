...
class _CxNavigationBarState extends FiBaseState<FiNavigationBarWidget> {
  ...
  Widget get content => Stack(
        children: [
          ...
          Positioned(top: toY(848), width: toX(25), height: toX(25), left: toX(36),  child:  GestureDetector(onTap:(){navigationBar.onTabClick(0);},child:Image(image: const AssetImage("assets/images/nb_home_icon.png"),color: _tabColor(0),width: toX(25),height: toX(25),))),
          Positioned(top: toY(848), width: toX(25), height: toX(25), left: toX(106), child:  GestureDetector(onTap:(){navigationBar.onTabClick(1);},child:Image(image: const AssetImage("assets/images/nb_contacts_icon.png"),color: _tabColor(1),width: toX(25),height: toX(25),))),
          Positioned(top: toY(811), width: toX(60), height: toY(71), left: toX(177), child:  GestureDetector(onTap:(){navigationBar.onTabClick(2);},child:Image(image: const AssetImage("assets/images/ai_man_big.png"),width: toX(25),height: toX(25),))),
